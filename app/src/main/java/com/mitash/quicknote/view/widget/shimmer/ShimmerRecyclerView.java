...
public class ShimmerRecyclerView extends RecyclerView {
    ...
    private void init(AttributeSet attrs) {
        ...
        try {
            if (a.hasValue(R.styleable.ShimmerRecyclerView_shimmer_child_count)) {
                setDemoChildCount(a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_child_count, 1));
            }

            if (a.hasValue(R.styleable.ShimmerRecyclerView_shimmer_layout_manager)) {
                int value = a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_layout_manager, 0);
                switch (value) {
                    case 1:
            ...
            if (a.hasValue(R.styleable.ShimmerRecyclerView_shimmer_grid_child_count)) {
                setGridChildCount(a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_grid_child_count, 2));
            }
        } finally {
            a.recycle();
        }
